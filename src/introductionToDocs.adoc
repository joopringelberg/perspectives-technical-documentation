...
* The https://joopringelberg.github.io/perspectives-documentation/userguide.html[InPlace User Guide], which is more of a reference.

* https://inplace.works/gettingstarted/overview.html[A small tutorial] to get started.
